...
class Pirateship2 extends Ship implements Observer                 //Extends the ship method to set the different images and different origins
                                                                   // and implements the observer pattern to follow the columbus ship
{
	...
	public ImageView loadShipImage(AnchorPane root)
	{
		...
		shipImageView.setX(4*scale);
		shipImageView.setY(5*scale);
